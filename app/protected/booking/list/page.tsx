import FilterButtonAndModal from "@/components/FilterButtonAndModal";
  ...
  return (
    <div className="mx-2">
      ...
      <div className="flex mt-3 w-full justify-between">
        <div className="pl-3">
          <p>
            <span className="text-neutral-900 text-base font-medium leading-6">Srinivasan</span> <span className="text-slate-500 text-sm font-normal leading-5">Inquiry</span>
          </p>
          <section>
      ...
      <div className="flex mt-3 w-full justify-between">
        <div className="pl-3">
          <p>
            <span className="text-neutral-900 text-base font-medium leading-6">Nithika Suresh</span> <span className="text-slate-500 text-sm font-normal leading-5">Quotation</span>
          </p>
          <section>
            <p className="text-slate-500 text-sm font-normal leading-5">2 days, 8 pax</p>
            <p className="text-slate-500 text-sm font-normal leading-5">Villa Armati</p>
            <p className="text-slate-500 text-sm font-normal leading-5">Rs 25,0000</p>
          </section>
        </div>
        <div className="w-[84px] flex items-center">
          <div className="w-[84px] h-9 px-5 bg-gray-100 rounded-[19px] justify-center items-center inline-flex items-center">
