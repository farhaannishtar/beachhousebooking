                        ...
                        <div className="flex flex-col gap-y-4 mt-6 ">
                            <div className="flex items-center gap-10">
                                ...
                                <div className="w-full">
                                    <label className="label_text !font-semibold mb-2 block tablet-down:hidden">Customer name</label>
                                    <BaseInput
                                ...
                                {/* Phone Input */}
                                <div className="w-full">
                                    <label className="label_text !font-semibold mb-2 block tablet-down:hidden">Phone</label>
                                ...
                                (isEvent && formState.form.status == "Inquiry")) && (
                                    <div className="flex gap-3 flex-wrap">
                                        <div className="flex-1">
                                            <label className="label_text !font-semibold mb-2 block tablet-down:hidden">Numbre of events</label>
                                            <BaseInput
                                                className="flex-1"
                                                preIcon="tag"
                                                name="numberOfEvents"
                                        ...
                                        <div className="flex-1">
                                            <label className="label_text !font-semibold mb-2 block tablet-down:hidden">Number of guests</label>
                                            <BaseInput
                                                className="flex-1"
                                                type="text"
                                                placeholder="Guests"
