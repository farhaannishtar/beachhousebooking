                    ...
                    <div className='flex flex-col gap-y-4 mt-6 mx-3'>
                        <label className="form-control w-full max-w-xs">
                            <input
                                ...
                                className="input w-full max-w-xs bg-inputBoxbg text-base font-normal text-placeHolderText placeholder:text-placeHolderText placeholder:text-base placeholder:leading-normal placeholder:font-normal"
                                name="name"
                                ...
                                <label className="w-full">
                                    <div className="relative flex items-center">
                                        <input
                                            type="text"
                                            placeholder="Events"
                                            className="pl-10 pr-3 py-2 w-full border rounded-lg text-base text-center font-normal font-normal text-placeHolderText placeholder:text-placeHolderText placeholder:text-base placeholder:leading-normal placeholder:font-normal"
                                            name="numberOfEvents"
                        ...
                        <div>
                            <label>
                                <textarea
                                    ...
                                    placeholder="Notes"
                                    onChange={handleChange}
                                    className={`textarea w-full text-base h-${textareaHeight} font-normal leading-normal bg-inputBoxbg rounded-xl text-placeHolderText placeholder:text-placeHolderText placeholder:text-base placeholder:leading-normal placeholder:font-normal`}
                                />
                            </label>
                        </div>
                        <div>
