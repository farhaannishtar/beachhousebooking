      ...
      <form onSubmit={handleSubmit}>
        ...
        {formState.showForm === ShowForm.Event && (
          <CreateEventComponent
            ...
            cancelAddEvent={() => handleStateChange(ShowForm.Booking)}
          />
        )}
