...
export default function BookingFormComponent({ bookingId }: BookingFormProps) {
        ...
        if (bookingId) {
            supabase
                ...
                .then(({ data: bookingsData }) => {
                    ...
                    setEventStaySwitchValue(
                        newData.bookingType === "Stay" ? false : true
                    );
                });
        }
    }, []);
    ...
    const [EventStaySwitchValue, setEventStaySwitchValue] = useState<boolean>(
    ...
    }, [formState.form.client.name, formState.form.client.phone]);
    ...
    const handleSwitchChange = (
        ...
        setEventStaySwitchValue(!EventStaySwitchValue);
    };
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (isValid) {
            ...
            console.log(form, form.bookingId);
        ...
        <div>
                      ...
                      Referral
                        ...
                        Events
                          ...
                          Add Event{" "}
                                            ...
                                            <h3 className="subheading text-right">
                                                {" "}
                        Final cost: ${formState.form.totalCost}
                                            </h3>
                                        </div>
                                    )}
                                    {/* Stay options */}
                        ...
                        Payments
                            ...
                            +
                                            ...
                                            <h3 className="subheading text-right">
                                                {" "}
                        Paid: ${formState.form.paid}
                                            </h3>
                                            <h3 className="title text-right">
                                                {" "}
                        Outstanding: ${formState.form.outstanding}
                                            </h3>
                                        </div>
                                    )}
                                    {/* Stay options */}
            ...
            {bookingId && formState.pageToShow === Page.BookingPage && (
              ...
              Next
                    ...
                    <div>
                        <p>
              Created by {formState.bookingDB?.createdBy.name} on{" "}
                            {convertToIndianTime(formState.bookingDB?.createdDateTime)}
                        </p>
                        <p>
              Updated by {formState.bookingDB?.updatedBy.name} on{" "}
                            {convertToIndianTime(formState.bookingDB?.updatedDateTime)}
                        </p>
                    </div>
                </div>
            )}
